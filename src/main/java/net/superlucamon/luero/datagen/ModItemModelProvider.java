...
public class ModItemModelProvider extends ItemModelProvider {
    ...
    protected void registerModels() {
        ...
        simpleItem(ModItems.REACTOR_TEST1);

        simpleItem(ModItems.STRAWBERRY);


        simpleItem(ModItems.IRONMAN_HELMET_MK47);
        simpleItem(ModItems.IRONMAN_CHESTPLATE_MK47);
        simpleItem(ModItems.IRONMAN_LEGGINGS_MK47);
        simpleItem(ModItems.IRONMAN_BOOTS_MK47);
    }
    ...
    public void evenSimplerBlockItem(RegistryObject<Block> block) {
        this.withExistingParent(Main.MOD_ID + ":" + ForgeRegistries.BLOCKS.getKey(block.get()).getPath(),
